...
int main() {
  ...
  int x = 1, y = 2, z = 3, last1 = 4, last2 = 5, last3 = 6;
  void *d;
  ...
  // test inserting a couple of elements to list tail
  assert(list_insert_last(l, &last1) == 0);
  assert(list_insert_last(l, &last2) == 0);
  assert(list_insert_last(l, &last3) == 0); 
